...
const DeviceCreationForm: React.FC<IDeviceCreateFormProps> = ({
                                                                  modalTitle,
                                                                  confirmLoading,
                                                                  visible,
                                                                  onCreate,
    ...
    return (
        ...
        >
            <Form form={ form } layout="vertical">
                ...
                <Form.Item name="image" label="Device logo" valuePropName="fileList"
                           getValueFromEvent={ uploadProps.normFile }>
                    {/*// extra="long"*/ }
            ...
            <div>
                { errors && errors.map((error, index) => <div key={ index }><Text
                    style={ { color: "red" } }>{ error }</Text></div>) }
            </div>
        </Modal>
    );
};
